...
void GUIApplication::startup()
{
	...
	Vertex a = Vertex(glm::vec4(-5, 5, 0, 1), glm::vec4(1, 0, 0, 1));
	Vertex b = Vertex(glm::vec4(5, 5, 0, 1), glm::vec4(0, 1, 0, 1));
	Vertex c = Vertex(glm::vec4(5, -5, 0, 1), glm::vec4(0, 0, 1, 1));
	Vertex d = Vertex(glm::vec4(-5, -5, 0, 1), glm::vec4(0, 0, 0, 1));
...
void GUIApplication::draw()
{
	...
	for(int x = 1; x <= 64; x++)
	{
		...
		mat = glm::translate(mat, glm::vec3(10  * xMultiple, yPos, 0));
